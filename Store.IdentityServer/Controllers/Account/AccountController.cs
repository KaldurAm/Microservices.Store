...
using Store.IdentityServer.Extensions;
...
namespace Store.IdentityServer.Controllers.Account;
...
public class AccountController : Controller
{
    ...
    public AccountController(IIdentityServerInteractionService interaction, IClientStore clientStore,
        IAuthenticationSchemeProvider schemeProvider, IEventService events, TestUserStore users = null)
    {
